 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1800, 1800, 500, 900 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 1000, 5000 } // ...or, set your own edit limits
#endif
...
#define PREHEAT_1_TEMP_HOTEND 290
...
//
  #define TFT_TRONXY_X5SA     //  tronxy config if not using SKR board
...
#define TFT_COLOR_UI          //  ps: TFT config
//#define TFT_LVGL_UI
